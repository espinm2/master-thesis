...
\section{Physical Sketch Interpretation Algorithm}
	...
	In practice, sketching still used during the early design of architecture because of the speed \& efficiently it offers designers\cite{Galasiu}.
	Due to sketching's speed and flexibility, a few architectural sketching interfaces were developed.
	...
	LightSketch gives users the ability to to draw walls, windows, and interior lighting elements to define architectural spaces\cite{glaser2003sketch}; The drawings are then interpreted and turned into 3D models.
	Users can then perform daylighting analysis and generate renderings from those 3D models.
	LightSketch, however, is limited to shoe-box geometries for rooms.
	Users cannot freely design a wide variety of non shoe-box floor plans, as is possible in the VR SketchPad project and the Virtual Heliodon.
