...
The both Virtual Heliodon and OASIS rely on the physical sketch interpretation algorithm and the daylight rendering engine. 
...
This triangle mesh is then used a input for the daylight rendering engine.
...
\section{Physical Sketch Interpretation Algorithm}
	...
	the 2D drawings are then interpreted and turned into 3D models through different methods than the physical sketch interpretation algorithm used in OASIS.
