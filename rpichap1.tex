...
\section{Daylighting In The Architectural Design Processes}
  ...
  % Go over in (3) sentences the stage 1
  % Go over in (3) sentences the stage 2
  ...
  % Small explaination as to why these tools are good (aka fast and easy)

  \paragraph{Rules-of-Thumb}
  % Explain what rules of thumb are
  % List the example of rules of thumb
  % Recap why they are widely used still

  \paragraph{Sketch Analysis}
  % Explain why sketches are important in general in architecture
  % Explain why they are important in daylighting
  % Explain some common ways architectures analysis sketches
  % - find the name of drawing sun angles and making rays on sketches
  % - find the name drawing selectional and floor plans
  % Recap why they are widely used still
  ...
  % Explain post construction evaluations can be preformed
