...
\section{Challenges Of Designing Daylighting Systems}
  ...
  \subsection{Adverse Daylighting Effects}
    ...
    However, having no control over automated dimming systems can cause occupants discomfort and result in occupants only relying on electrical lighting.%there is no source, but it's too good to leave out.. 
    \\
